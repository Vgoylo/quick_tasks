...
def letter(arr_wisth_strings)
  arr_wisth_strings.reject do |element|
    element.include?('a')
  end.map(&:reverse)
end

p letter(%w[apple hello yes brother erewrthjytyukjy sample aaagfggfdaaaaa])
...
puts consonant_count(%w[hello apple son asdfghj qwertyuiop aaaaaaaa])
